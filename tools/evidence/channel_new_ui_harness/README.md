...
The script reads `.env.local`, starts the local backend when needed, runs a
Flutter Chrome integration test for the UI flow, runs API and direct Turso
...
- `01-initial-sidebar.png`: sidebar before clicking New Channel.
- `01b-new-channel-dialog.png`: New Channel dialog after opening.
- `01c-channel-name-entered.png`: New Channel dialog after entering the name.
- `02-after-create-sidebar.png`: UI state immediately after submitting.
