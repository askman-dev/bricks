...
+----------------------+      +-------------------------------+
              ...
              v                          v                          v
+---------------------------+  +-------------------+  +---------------------------+
| Learn to Build a Rocket   |  | Save Two Million  |  | Learn 3D Printing         |
+---------------------------+  |     (Gemini)      |  +---------------------------+
         |          |          +-------------------+        |              |
         v          v                                       v              v
 +------------+ +---------+                      +---------------+ +--------------+
 | Propulsion | | Cosmic  |                      | Printing      | | Modeling Lab |
 | Systems    | | Velocity|                      | Materials     | | (openclaw ☁️)|
 +------------+ +---------+                      | (Gemini)      | +--------------+
         |          |                            +---------------+        |
         +----------+                                                     |
              |                                                           |
