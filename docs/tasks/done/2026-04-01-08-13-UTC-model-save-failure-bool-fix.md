...
> **Note:** Phase 1 below was superseded by follow-up feedback. The chosen wire format is numeric `1/0` (not boolean). The backend now normalizes both formats; see `docs/tasks/done/2026-04-01-08-56-UTC-model-is-default-number-format.md` and `docs/tasks/done/2026-04-01-09-22-UTC-backend-is-default-normalization.md`.
