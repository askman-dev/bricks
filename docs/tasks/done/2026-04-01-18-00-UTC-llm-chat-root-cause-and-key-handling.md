...
# Acceptance Criteria
- This document is clearly marked and used as the canonical plan for this session, even if earlier drafts from the same date remain under `docs/tasks/done/`.
