...
The repository requires implementation plans to be persisted under `docs/tasks/done/`, but the desired plan-writing structure has been refined through discussion.
...
- Require every implementation plan to be saved under `docs/tasks/done/` with a timestamped filename.
...
- The skill requires plans to be saved under `docs/tasks/done/` with timestamped filenames.
